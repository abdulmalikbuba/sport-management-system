        ...
        <div class="card-body">
            <div class="page-wrapper">
                ...
                <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa-solid me-2 fa-plus"></i>Add Student
                </button>
                ...
                <table id="myTable" class="table hover table-responsive-sm table-sm" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>2</td>
                            <td>
                                <img src="$resourceURL('app/images/img/7.png')" style="height:40px;" alt="" />
                            </td>
                            <td>Fatawu Abdullai</td>
                            <td>General Arts</td>
                            <td>3A</td>
                            <td>
                                <a href="dashboard/edit-product/{$EncodedID}" class="btn btn-sm btn-success">
                        ...
                        <tr>
                            <td>3</td>
                            <td>
                                <img src="$resourceURL('app/images/img/6.png')" style="height:40px;" alt="" />
                            </td>
                            <td>Gideon Agyei </td>
                            <td>Visual Arts</td>
                            <td>2C</td>
